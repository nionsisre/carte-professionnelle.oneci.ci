...
class HomeController extends Controller
{
    ...
    public function show() {
        ...
        $nombre_demandes = Customer::where('customers_statut_id','>=','2')->count();
        $nombre_demandes_non_traitees = Customer::where('customers_statut_id','=','2')->count();
        $nombre_demandes_daily = Customer::where('customers_statut_id','>=','2')->where('updated_at','LIKE',date("Y-m-d").'%')->count();
        $nombre_demandes_monthly = Customer::where('customers_statut_id','>=','2')->where('updated_at','LIKE',date("Y-m").'%')->count();
        $nombre_demandes_validees = Customer::where('customers_statut_id','>=','4')->count();
        $nombre_demandes_validees_daily = Customer::where('customers_statut_id','>=','4')->where('updated_at','LIKE',date("Y-m-d").'%')->count();
        $nombre_demandes_validees_monthly = Customer::where('customers_statut_id','>=','4')->where('updated_at','LIKE',date("Y-m").'%')->count();
        $nombre_demandes_refusees = Customer::where('customers_statut_id','=','3')->count();
        $nombre_demandes_refusees_daily = Customer::where('customers_statut_id','=','3')->where('updated_at','LIKE',date("Y-m-d").'%')->count();
        $nombre_demandes_refusees_monthly = Customer::where('customers_statut_id','=','3')->where('updated_at','LIKE',date("Y-m").'%')->count();
        $nombre_demandes_traitees = Customer::where('customers_statut_id','>=','3')->count();
        $nombre_demandes_traitees_daily = Customer::where('customers_statut_id','>=','3')->where('updated_at','LIKE',date("Y-m-d").'%')->count();
        $nombre_demandes_traitees_monthly = Customer::where('customers_statut_id','>=','3')->where('updated_at','LIKE',date("Y-m").'%')->count();
