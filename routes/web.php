...
Route::prefix('oneciwebadmin')->group(function () {
    ...
    Route::middleware(['auth:web'])->group(function () {
        ...
        Route::post(sha1('/data/customer/approved-unknown'.date('Ymd').env('APP_KEY')).'/{numero_dossier}', [ProcessPreIdentificationController::class, 'approveUnknownClientByNumeroDossier'])->name('admin.pre-identification.client.approve-unknown');
