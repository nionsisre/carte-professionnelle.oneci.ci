<script>
    ...
    function ajaxRestApiSender(url, client, token, request_instruction, request_data, responseCallbackFunction, loader_enabled, container_id) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                if (loader_enabled)
                    $(container_id).append('<div id="loader" class="text-center"><br/><br/><img alt="." src="back-office/assets/images/loaders/loader15.gif" style="max-height: 4rem; max-width: 4rem;"/><br/><br/><br/></div>');
            },
