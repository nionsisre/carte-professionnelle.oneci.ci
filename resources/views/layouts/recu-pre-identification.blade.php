                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                                            ...
                                                            @else
                                                                <img align="center" border="0" src="{{ URL::asset('assets/images/sim-card.png') }}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 5%;max-width: 58px;" width="58" class="v-src-width v-src-max-width"/>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;" align="left">
                                                <div class="v-text-align" style="color: #47484b; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong><span style="line-height: 25.2px; font-size: 18px;">Pré-identification pour abonné mobile</span></strong></span></p>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                <td style="overflow-wrap:break-word;word-break:break-word;padding:16px;font-family:'Open Sans',sans-serif;" align="left">
                                                    ...
                                                    <div class="v-text-align" style="color: #615e5e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                        <p style="font-size: 14px; line-height: 140%;"><b><span style="font-size: 12px; line-height: 16.8px;"><span>Pour télécharger votre fiche de d’identification, veuillez scanner le QR Code ci-dessus ou rendez vous sur le lien suivant : <br/>{{ route('front_office.auth.recu_pre_identification.url').'?f='.$numero_dossier.'&t='.$uniqid }}<br/><br/></span>&nbsp;</span></b></p>
                                                    </div>
