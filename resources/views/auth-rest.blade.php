      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          ...
          <section class="login_content">
              ...
              @endif
              <form method="post" action="{{ route('oneci.update.password') }}>
                  @csrf
              <h1>Modification du mot de passe</h1>
              <div>
                 <input  name="password" type="text" class="form-control" placeholder="Nouveau mot de passe" required/>
              </div>
              <div>
                <input name="passwordupdate" type="password" class="form-control" placeholder="Nouveau mot de passe" required/>
              </div>
              <div>
