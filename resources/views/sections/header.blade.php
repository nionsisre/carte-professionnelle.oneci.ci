    ...
    <div class="navbar-collapse">
        <ul class="navbar-nav">
            <li <?php if (isset($routes[1]) && $routes[1] === "accueil" || !(isset($routes[1]))) echo 'class="current"' ?>>
                <a href="<?php echo "https://www.oneci.ci/accueil" ?>">Accueil</a>
            </li>
            <li <?php if (isset($routes[1]) && $routes[1] === "qui-sommes-nous") echo 'class="current"' ?>>
                <a href="<?php echo "https://www.oneci.ci/qui-sommes-nous" ?>">Qui sommes-nous ?</a>
            </li>
            <li <?php if (isset($routes[1]) && $routes[1] === "carte-identite") echo 'class="current"' ?>>
                ...
                <div class="sub-menu">
                    ...
                    <div class="sub-menu-item">
                        ...
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/documents-a-fournir" ?>"><i
                            ...
                            <li>
                                <a href="<?php echo "https://www.oneci.ci/nos-produits/procedure-de-retrait-special-de-cni" ?>"><i
                                        class="fad fa-hand-receiving fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Procédure de retrait spécial de CNI</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/liste-centres-correction" ?>"><i
                                        class="fad fa-map-marker-edit fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Liste des centres de correction</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/liste-centres-enrolement" ?>"><i
                                        class="fad fa-map-marker-alt fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Liste des centres d'enrôlement</a></li>
                            <li>
                                <a href="<?php echo "https://www.oneci.ci/carte-identite/liste-centres-distribution" ?>"><i
                                        class="fad fa-map-marker-alt fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Liste des centres de retrait</a></li>
                            <li style="margin-bottom: 0.5em"><a
                                    href="<?php echo "https://www.oneci.ci/carte-identite/liste-centres-enrolement-et-distribution" ?>"><i
                                        class="fad fa-map-marker-alt fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                    ...
                    <div class="sub-menu-item">
                        <h4 style="padding: 1em 0em; border-bottom: solid 1px #ccc;margin-right: 3em">Attestation
                            d'Identité</h4>
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/attestation-identite" ?>"><i
                                        class="fad fa-copy fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Liste des documents à fournir</a></li>
                            <br/>
                    ...
                    <div class="sub-menu-item">
                        <h4 style="padding: 1em 0em; border-bottom: solid 1px #ccc;margin-right: 3em">Carte de
                            Résident</h4>
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-resident/documents-a-fournir" ?>"><i
                                        class="fad fa-copy fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Liste des documents à fournir</a></li>
                            <br/>
                    ...
                    <div class="sub-menu-item">
                        <h4 style="padding: 1em 0em; border-bottom: solid 1px #ccc;margin-right: 3em">Extrait de
                            naissance</h4>
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/etat-civil" ?>"><i
            ...
            <li <?php if (isset($routes[1]) && $routes[1] === "carte-identite") echo 'class="current"' ?>>
                ...
                <div class="sub-menu">
                    ...
                    <div class="sub-menu-item">
                        ...
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/service-vip" ?>"><i
                            ...
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/suivi-de-statut" ?>"><i
                                        class="fad fa-check-double fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Suivi du statut de la CNI</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/rechercher-cni-perdue" ?>"><i
                                        class="fad fa-search fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Rechercher une CNI perdue</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/carte-identite/declarer-cni-retrouvee" ?>"><i
                            ...
                            <!--<li><a href="https://www.oneci.ci/nos-services/retrait-special-de-cni" ?>"><i class="fad fa-hand-receiving fa-1x mr10" style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i> &nbsp; Initier un retrait spécial de CNI</a></li>-->
                    ...
                    <div class="sub-menu-item">
                        <h4 style="padding: 1em 0em; border-bottom: solid 1px #ccc;margin-right: 3em">
                            Authentification</h4>
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/nos-services/service-authentification" ?>"><i
                            ...
                            <!--<li><a href="<?php echo "https://www.oneci.ci/nos-services/demande-de-nni" ?>"><i class="fad fa-barcode fa-1x mr10" style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i> &nbsp; Initier une demande de numéro NNI</a></li>-->
                            <li><a href="<?php echo "https://www.oneci.ci/nos-services/commande-de-tvi" ?>"><i
                    ...
                    <div class="sub-menu-item">
                        <h4 style="padding: 1em 0em; border-bottom: solid 1px #ccc;margin-right: 3em">
                            Réclamation</h4>
                        <ul>
                            <li><a href="<?php echo "https://www.oneci.ci/nos-services/service-reclamation" ?>"><i
                                        class="fad fa-headset fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Service Réclamation</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/nos-services/retard-de-production" ?>"><i
                    ...
                    <div class="sub-menu-item" style="margin: 0; padding: 0;width: 100%">
                        <img src="<?php echo "https://www.oneci.ci/assets/images/nos-services-illustration.jpg"; ?>"
            ...
            <li <?php if (isset($routes[1]) && $routes[1] === "contacts") echo 'class="current"' ?>>
                <a href="<?php echo "https://www.oneci.ci/contacts" ?>">Contacts</a>
            </li>
            <li>
                ...
                <div class="sub-menu">
                    ...
                    <div class="sub-menu-item">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo "https://www.oneci.ci"; ?>"><i
                                        class="fad fa-newspaper fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Actualités</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/documentation" ?>"><i
                                        class="fad fa-archive fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; Documentation</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/oneci-carriere" ?>"><i
                                        class="fad fa-building fa-1x mr10"
                                        style="--fa-primary-color: #F78E0C; --fa-secondary-color:#388E3C; --fa-secondary-opacity:0.9; margin-bottom: 0.2em"></i>
                                    &nbsp; ONECI Carrière</a></li>
                            <li><a href="<?php echo "https://www.oneci.ci/mediatheque" ?>"><i
                    ...
                    <div class="sub-menu-item">
                        <div align="center" style="position: relative; top:40%">
                            <a href="<?php echo "https://www.oneci.ci/l-oneci-vous-ecoute"; ?>" class="button black">
                    ...
                    <div class="sub-menu-item" style="margin: 0; padding: 0;width: 100%">
                        <img
                            src="<?php echo "https://www.oneci.ci/assets/images/services-divers-illustration.jpg"; ?>"
