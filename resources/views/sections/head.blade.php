...
<!--<link href="{{ URL::asset('assets/css/smart-wizard/smart_wizard_arrows.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/css/smart-wizard/smart_wizard_dots.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/css/smart-wizard/smart_wizard_round.min.css') }}" rel="stylesheet">
